...

{
  ...
  shorthand: "GitHub",
  proficiency: 90,
  description: "GitHub—the largest and most advanced development platform in the world.",
...

{
  ...
  shorthand: "WP",
  proficiency: 60,
  description: "WordPress (WP, WordPress.org) is a free and open-source content management system (CMS) written in PHP[4] and paired with a MySQL or MariaDB database.",
...

{
  ...
  shorthand: "Fauna",
  proficiency: 10,
  description: "Fauna is a flexible, developer-friendly, transactional database delivered to you as a secure, web-native API.",
  url: "https://fauna.com/",
}
...

{
  ...
  shorthand: "LR",
  proficiency: 95,
  description: "Lightroom is the cloud-based service that gives you everything you need to create, edit, organize, store, and share your photos across any device.",
