...
import hrLogo from '../../assets/hansonroboticslogo.png'
import dfoLogo from '../../assets/dfologo.png'
import gmLogo from '../../assets/greenMoustacheLogo.jpg'
import sgscLogo from '../../assets/sgscLogo.png'
...
const Company = () => {
  ...
  return (
    <Grid container className={classes.root} spacing={10} alignItems='center'>
      <Grid item xs={12}>
        ...
        <Grid item container justify='center' xs={6} md={3}>
          ...
          >
            <Card height='270px' width='246px'>
              ...
              >
                <Grid item>
                  <img src={hrLogo} alt='hanson robotics logo'></img>
                </Grid>
                <Grid item>
        ...
        <Grid item container justify='center' xs={6} md={3}>
          ...
          >
            <Card height='270px' width='246px'>
              ...
              >
                <Grid item>
                  <img src={dfoLogo} alt='DFO logo'></img>
                </Grid>
                <Grid item>
                  <Typography variant='h5' align='center'>
                    Direct Focus Online
        ...
        <Grid item container justify='center' xs={6} md={3}>
          ...
          >
            <Card height='270px' width='246px'>
              ...
              >
                <Grid item>
                  <img src={gmLogo} alt='The Green Moustache logo'></img>
                </Grid>
                <Grid item>
                  <Typography variant='h5' align='center'>
                    The Green Moustache
